    ...
    public static class Sysproxy
    {
        ...
        private static void Save()
        {
            try {
                using (StreamWriter sw = new StreamWriter(File.Open(_userWininetConfigFile, FileMode.Create))) {
                    string jsonString = SimpleJson.SimpleJson.SerializeObject(_userSettings);
                    sw.Write(jsonString);
                    sw.Flush();
                }
            } catch (IOException e) {
        ...
        private static void Read()
        {
            try {
                ...
                _userSettings = SimpleJson.SimpleJson.DeserializeObject<SysproxyConfig>(configContent);
            } catch(Exception) {
